...
const Hamburger_menu = ({showMenu}) => {
  ...
  return (
    <div className={showMenu ?"hamburger lg:w-[45vw] w-[100vw] min-h-[100vh] flex items-center justify-center fixed top-0 left-0 z-10 border-2 border-[#FF00BF] transition-all":"hamburger lg:w-[45vw] w-[100vw] min-h-[100vh] flex items-center justify-center fixed top-0 left-[-100vw] lg:left-[-45vw] z-10 border-2 border-[#FF00BF] transition-all"} style={{background:"linear-gradient(to bottom,rgba(70, 190, 212, 0.44),rgba(177, 114, 218, 0.74),rgba(208, 60, 171, 0.55))"}}>
        <div className="hamburger_menu flex flex-col ">
        <a href="#about" className="hamburger_links">About</a>
        <a href="#events" className="hamburger_links">Events</a>
        <a href="#gallery" className="hamburger_links">Gallery</a>
        <a href="#contact" className="hamburger_links">Contact</a>
        </div>
        ...
        <div className="image_wrapper absolute top-0 right-1">
          <Image src={right_svg} alt="right" className="right_svg min-h-[unset] bottom-[unset] h-[100vh]"/>
        </div>
    </div>
  )
}
