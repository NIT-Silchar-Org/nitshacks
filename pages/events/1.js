            ...
            <div className={styles.details}>
              ...
              <ul className={styles.ulist}>
                ...
                <li>
                  ...
                  in this contest. They have to form groups of [x] members and
                  tackle the problem opted by them accordingly.
                </li>
                <li>
                  The contest would consist of two rounds- Prelims and Mains.
                  Based on the results of the Prelims round, [x] number of teams
                  will be finally selected for the main round.
                </li>
                <li>
                  The prelims round will be held in the online mode, whereas the
                  final round will be an onsite round being held live in our
                  college.
                </li>
                <li>
                  The prelims round would be held from x to y and the results of
                  the prelims round will be declared on [x] date. The final
                  round will be held on [xyz] date. The results of which will be
                  announced on the [same day/ on this date]
                </li>
                <li>
                  The winners of the Final round will be awarded with exciting
                  prizes worth [x amount].
                </li>
              </ul>
            </div>
